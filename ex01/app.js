...
module.exports = (app, io) => {
  ...
  const connStr = 'mongodb+srv://new-user_31:382704@cluster0-wkz0k.mongodb.net/test?retryWrites=true&w=majority';
  ...
  app.use('/', index);
  app.use('/users', users);
  app.use('/courses', courses(io)); // socket.io를 인자로 주기 위해 function으로 변경
